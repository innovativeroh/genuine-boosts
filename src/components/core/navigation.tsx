...
const navigation = () => {
  return (
    <div className='border-[#233453] border-b-[1px] mt-8'>
        ...
        <button className='bg-transparent px-4 py-2 border-transparent text-white text-sm border-b-[2px]'>Contact</button>
        ...
        <button className='bg-transparent px-4 py-2 border-transparent text-white text-sm border-b-[2px]'>Trusted Advisor</button>
